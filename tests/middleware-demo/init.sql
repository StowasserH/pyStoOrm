-- Classic Models Database Schema for pyStoOrm Middleware Demo
-- Based on the famous MySQL tutorial database
...
-- Insert Sample Data (in correct order to satisfy FK constraints)

-- 1. Insert offices first
...
-- 2. Insert employees (with valid office references)
...
-- 4. Insert products (with valid product line references)
...
-- 5. Insert customers (with valid employee references)
...
(119, 'La Rochelle Gifts', 'Labrune', 'Janine', '40.67.8555', '67 rue des Cinquante Otages', NULL, 'Nantes', NULL, '44000', 'France', 1056, 118400.00),
...
-- 6. Insert orders (with valid customer references)
...
-- 7. Insert order details (with valid order and product references)
