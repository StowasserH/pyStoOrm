...
CREATE TABLE customers (customerNumber INTEGER NOT NULL, customerName TEXT NOT NULL, contactLastName TEXT NOT NULL, contactFirstName TEXT NOT NULL, phone TEXT NOT NULL, addressLine1 TEXT NOT NULL, addressLine2 TEXT DEFAULT NULL, city TEXT NOT NULL, state TEXT DEFAULT NULL, postalCode TEXT DEFAULT NULL, country TEXT NOT NULL, salesRepEmployeeNumber INTEGER DEFAULT NULL, creditLimit REAL DEFAULT NULL, PRIMARY KEY (customerNumber), CONSTRAINT customers_ibfk_1 FOREIGN KEY (salesRepEmployeeNumber) REFERENCES employees (employeeNumber));
...
CREATE TABLE employees (employeeNumber INTEGER NOT NULL, lastName TEXT NOT NULL, firstName TEXT NOT NULL, extension TEXT NOT NULL, email TEXT NOT NULL, officeCode TEXT NOT NULL, reportsTo INTEGER DEFAULT NULL, jobTitle TEXT NOT NULL, PRIMARY KEY (employeeNumber), CONSTRAINT employees_ibfk_1 FOREIGN KEY (reportsTo) REFERENCES employees (employeeNumber), CONSTRAINT employees_ibfk_2 FOREIGN KEY (officeCode) REFERENCES offices (officeCode));
...
CREATE TABLE offices (officeCode TEXT NOT NULL, city TEXT NOT NULL, phone TEXT NOT NULL, addressLine1 TEXT NOT NULL, addressLine2 TEXT DEFAULT NULL, state TEXT DEFAULT NULL, country TEXT NOT NULL, postalCode TEXT NOT NULL, territory TEXT NOT NULL, PRIMARY KEY (officeCode));
...
CREATE TABLE orderdetails (orderNumber INTEGER NOT NULL, productCode TEXT NOT NULL, quantityOrdered INTEGER NOT NULL, priceEach REAL NOT NULL, orderLineNumber smallint(6) NOT NULL, PRIMARY KEY (orderNumber,productCode), CONSTRAINT orderdetails_ibfk_1 FOREIGN KEY (orderNumber) REFERENCES orders (orderNumber), CONSTRAINT orderdetails_ibfk_2 FOREIGN KEY (productCode) REFERENCES products (productCode));
...
CREATE TABLE orders (orderNumber INTEGER NOT NULL, orderDate TEXT NOT NULL, requiredDate TEXT NOT NULL, shippedDate TEXT DEFAULT NULL, status TEXT NOT NULL, comments TEXT, customerNumber INTEGER NOT NULL, PRIMARY KEY (orderNumber), CONSTRAINT orders_ibfk_1 FOREIGN KEY (customerNumber) REFERENCES customers (customerNumber));
...
CREATE TABLE payments (customerNumber INTEGER NOT NULL, checkNumber TEXT NOT NULL, paymentDate TEXT NOT NULL, amount REAL NOT NULL, PRIMARY KEY (customerNumber,checkNumber), CONSTRAINT payments_ibfk_1 FOREIGN KEY (customerNumber) REFERENCES customers (customerNumber));
...
CREATE TABLE productlines (productLine TEXT NOT NULL, textDescription TEXT DEFAULT NULL, htmlDescription mediumtext, image mediumblob, PRIMARY KEY (productLine));
...
CREATE TABLE products (productCode TEXT NOT NULL, productName TEXT NOT NULL, productLine TEXT NOT NULL, productScale TEXT NOT NULL, productVendor TEXT NOT NULL, productDescription TEXT NOT NULL, quantityInStock smallint(6) NOT NULL, buyPrice REAL NOT NULL, MSRP REAL NOT NULL, PRIMARY KEY (productCode), CONSTRAINT products_ibfk_1 FOREIGN KEY (productLine) REFERENCES productlines (productLine));
